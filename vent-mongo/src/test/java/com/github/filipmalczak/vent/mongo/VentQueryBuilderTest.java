...
import com.github.filipmalczak.vent.mongo.query.operator.*;
...
class VentQueryBuilderTest {
    ...
    private VentQuery query(Operator rootOperator){
        return new VentQuery(COLLECTION_NAME, rootOperator, mongoQueryPreparator, mongoTemplate, snapshotService, collectionService, ventDb.getTemporalService());
    }
}